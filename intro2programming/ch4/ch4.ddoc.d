...
$(P
Functions in programming are the main building blocks.
To use a function you have to $(I call) it.
Calling a function is like saying that at some particular moment during
the execution you want to execute code of the funtion
and once the function code is executed you return
back to the point where it was called.
By calling one function from inside another function you
can build as complex functionality as required.
)
...
time and some computer resources. 
)
$(LI
But $(I function) in computer schience is not only an abstraction easy for us to understand,
...
Say someone wrote a function, if it generic enough then everyone else can also use it.
