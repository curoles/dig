...
$(P
Except for one thing, we have so far learned about
...
$(LI
Keywords `if` and `else` responsible for $(I Thing #3: Choose between two options).
)
$(LI
Keywords `for` and `foreach` do $(I Thing #4: Looping and repeating).
)
$(LI
